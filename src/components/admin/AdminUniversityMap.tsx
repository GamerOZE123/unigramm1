...
const AdminUniversityMap: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* STATE DOSSIER (left side, slides in when a state is clicked) */}
      <aside
        style={{
          position: "absolute",
          left: intelOpen ? 320 : 0,
          top: 48,
          bottom: 0,
          width: 320,
          zIndex: 22,
          background: "linear-gradient(135deg, rgba(0,8,20,0.97) 0%, rgba(0,4,12,0.92) 100%)",
          borderRight: "1px solid rgba(0,255,231,0.15)",
          display: "flex",
          flexDirection: "column",
          transform: stateDossierOpen && selectedState ? "translateX(0)" : "translateX(-110%)",
          transition: "transform 0.35s cubic-bezier(0.4,0,0.2,1), left 0.25s ease",
          backdropFilter: "blur(24px)",
          boxShadow: "8px 0 24px rgba(0,255,231,0.06)",
        }}
      >
        {selectedState && (() => {
          const selKey = normState(selectedState.name);
          const colleges = allUniv.current
            .filter((u) => normState(u.state) === selKey)
            .filter((u) =>
              !stateSearch
                ? true
                : u.name.toLowerCase().includes(stateSearch.toLowerCase()) ||
                  (u.abbr || "").toLowerCase().includes(stateSearch.toLowerCase())
            )
            .sort((a, b) => {
              const at = isTier1(a.name) ? 1 : 0;
              const bt = isTier1(b.name) ? 1 : 0;
          ...
          return (
            <>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <Crosshair size={11} color="#00ffe7" />
                  <span style={{ fontSize: 9, color: "#00ffe7", letterSpacing: "0.3em" }}>
                    STATE DOSSIER
                  </span>
                </div>
                <button
                  onClick={() => setStateDossierOpen(false)}
                  style={{
                    background: "none",
                    border: "none",
                    color: "rgba(0,255,231,0.6)",
              ...
              <div style={{ padding: "16px 18px 12px", borderBottom: "1px solid rgba(0,255,231,0.1)" }}>
                <div
                  style={{
                    fontSize: 18,
                    color: "#e6fffd",
                ...
                <div style={{ fontSize: 9, color: "rgba(0,255,231,0.5)", letterSpacing: "0.2em", marginTop: 4 }}>
                  INDIA · STATE SECTOR
                </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginTop: 12 }}>
                  ...
                  >
                    <div style={{ fontSize: 8, letterSpacing: "0.2em", color: "rgba(0,255,231,0.55)" }}>
                      COLLEGES
                    </div>
                    <div style={{ fontSize: 20, color: "#00ffe7", fontWeight: 700, fontFamily: "'Space Mono', monospace" }}>
                      {selectedState.total}
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div style={{ fontSize: 8, letterSpacing: "0.2em", color: "rgba(255,200,0,0.7)" }}>
                      TIER-1
                    </div>
                    <div style={{ fontSize: 20, color: "#ffcc33", fontWeight: 700, fontFamily: "'Space Mono', monospace" }}>
                      {selectedState.tier1}
                    </div>
                  </div>
                </div>
              ...
              <div style={{ padding: "10px 14px", borderBottom: "1px solid rgba(0,255,231,0.08)" }}>
                <div
                  style={{
                    display: "flex",
                    alignItems: "center",
                ...
                >
                  <Search size={11} color="rgba(0,255,231,0.5)" />
                  <input
                    value={stateSearch}
                      ...
                      >
                        <div
                          style={{
                            ...
                            height: 6,
                            borderRadius: "50%",
                            background: tier1 ? "#ffcc33" : "#00ffe7",
                            boxShadow: tier1 ? "0 0 6px #ffcc33" : "0 0 4px #00ffe7",
                            flexShrink: 0,
                          }}
                        />
                        ...
                        <ChevronRight size={12} color="rgba(0,255,231,0.4)" />
                      </button>
                    );
                  })
                )}
              ...
              >
                <span style={{ fontSize: 8, color: "rgba(0,255,231,0.4)", letterSpacing: "0.15em" }}>
                  {colleges.length} / {selectedState.total} SHOWN
                </span>
                <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                  <div
                    style={{ width: 4, height: 4, borderRadius: "50%", background: "#00ff88", boxShadow: "0 0 4px #00ff88" }}
                    className="pulse-dot"
                  />
                  <span style={{ fontSize: 8, color: "#00ff88", letterSpacing: "0.15em" }}>SYNCED</span>
                </div>
              </div>
            </>
          );
