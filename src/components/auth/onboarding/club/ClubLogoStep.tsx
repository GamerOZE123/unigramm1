...
export default function ClubLogoStep({ onNext, onBack, onData, initialData }: ClubLogoStepProps) {
  const { user } = useAuth();
  ...
  return (
    <div className="space-y-6 bg-card p-8 rounded-lg shadow-lg">
      <div>
        <h2 className="text-2xl font-bold mb-2">Club Logo</h2>
        <p className="text-muted-foreground">Upload your club logo (optional)</p>
      </div>
